                  ...
                  return(
                      <div style={{display:"flex",margin:"20px"}} key={item._id}>
                          ...
                          <div style={{marginLeft:"20px"}}>
                              ...
                              <h6>{item.quantity} x  Rs. {item.product.price}</h6>
    ...
    const TotalPrice = ()=>{
        return(
            <div className="container" style={{display:"flex",justifyContent:"space-between"}}>
                ...
                billingAddress={true}
                zipCode={true}
                stripeKey="pk_test_51IJbCcJfictJUewlKosPkK2H5Bn3s78jNGQTjhXjlsI9ym7MVo70Ek9lEgYS7u11GmIQza68ZntVcXMSxuaVIaKZ00rdxYTJMl"
